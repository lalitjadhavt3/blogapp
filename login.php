<?php
  ...
  if(empty($_SESSION['access_token'])) {
    ...
    $google_login_btn = '<a class="btn btn-info btn-lg w-100" href="'.$google_client->createAuthUrl().'">Login / Signup with <img src="test/logo.png" style="width: 30px;margin-left: 4%;"></a>';
  ...
  <body>
    ...
    <div class="login-wrapper d-flex align-items-center justify-content-center">
      ...
      <div class="container">
        ...
        <!-- Login Meta-->
        <div class="login-meta-data text-center" style="margin-top: 5%"><!-- <a class="forgot-password d-block mt-3 mb-1" href="forget-password.html">Forgot Password?</a> -->
